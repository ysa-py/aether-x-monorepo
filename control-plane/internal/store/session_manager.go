...
// MigrateSession handles QUIC Connection ID migration (TUIC v5 / Hysteria2)
// Allows transparent socket migration without dropping active TCP streams
...
// AutoFailover detects dead sessions and migrates them to healthy nodes
// Implements zero-disconnection: session preserved, node swapped
